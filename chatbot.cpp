...
int main()
{
  ...
  while (1)
  {
    ...
    else if (!strcmp(s, "tell me more about yourself") || !strcmp(s, "tell me about yourself") || !strcmp(s, "tell me more about you") || !strcmp(s, "who are you?") || !strcmp(s, "what are you?"))
    {
      ...
      {
      case 1:
        cout << "I am chat bot v-3. I was created by Suprayvo.";
        break;
      case 2:
        cout << "I am a simple chat bot coded by Suprayvo on his computer.";
        break;
      case 3:
        cout << "I am a simple program code that can talk";
        break;
      case 4:
        cout << "I am a simple program code that can talk and I was created by Suprayvo";
        break;
      case 5:
